...
load_socketio = function() {
  load_js("http://" + location.host + "/socket.io/socket.io.js",load_socketio.try_ready)
}
...
load_css = function() {
  ...
  css.setAttribute('href','http://' + location.host + '/stylesheets/bookmarklet.css');
...
Graphedia.prototype.setup_socket = function() {
  ...
  g.socket = io.connect('http://' + location.host,3000);
