...
MiniDash.prototype.guest = function() {
  ...
  login_username.focus(function() {
    if($g(this).val() == $g(this).attr('title')) $g(this).val('').removeClass('italic');
  })
  login_username.blur(function() {
    if($g(this).val() == '') $g(this).val($g(this).attr('title')).addClass('italic')
  })
  var login_password = $g('<input>',{type:'password',name:'password'}).addClass('password');
  login.append(login_username,login_password);
