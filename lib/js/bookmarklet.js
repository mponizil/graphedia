...
Comment.prototype.add = function() {
  ...
  var container = $g('<div>').addClass('commentContainer').css({
    ...
    'top': (c.y-10) +'px',
    'left': (c.x-13)+'px'
  }).attr('id',c.comment_id); //c.author + ' says ' + 
...
Comment.prototype.create = function() {
  ...
  var comment = $g('<textarea>').addClass('commentField').attr('name','new_comment').css({'font-size': '12px', 'width':'210px', 'padding':'10px','height':'37px'});
