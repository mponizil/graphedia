  ...
  if(username && password) {
    ...
    User.findOne({ username: username, password: password }, function(err, user) {
      if(user) {
        ...
        CommentStream.find({ 'comments.author_id': user._id }, function(err, my_comments) {
          // console.log(my_comments)
          res.render('dashboard', { url: _r.URL, _id: user._id, username: user.username, my_comments: my_comments });
        })
      } else {
